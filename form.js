...
//         //bind
//         $('#wrapper')
//             .on('click', '.title a', Form.navigate)
//             .on('click', '.actions .delete', Form.deleteQuestion)
//             .on('click', '.actions .monitor', Form.toggleMonitor)
//             .on('click', '.markread', function () {
//                 var link = $(this);
//                 Form.markAsRead(link.parents('.q'));
//                 link.hide();
//             })
//             .on('click', '.clear', Form.reset)
//             .on('click', '.addthis', Form.addQuestion)
//         ;
//     }
