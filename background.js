//if jQuery isn't loaded for some reason, load it
if (!window.jQuery) {
...
var BG = {
    ...
    , apiGetSuccess: function (data, site) {
        if (data) {
            ...
            BG.getPopup();
            if (BG.popup) BG.popup.Form.renderQuestions(); //if the popup is visible, update it
            BG.updateBadge();
        } else BG.handleError(data);
